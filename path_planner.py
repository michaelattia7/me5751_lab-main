...
#when you decide which points belong on the map, you just add the pose
		self.path.add_pose(Pose(map_i = 10, map_j = 12, theta = 0))
		self.path.add_pose(Pose(map_i=11, map_j=12, theta=0))
		self.path.add_pose(Pose(map_i=102, map_j=12, theta=0))
#delete this line later
		points = bresenham(self.start_state_map.map_i,self.start_state_map.map_j,self.goal_state_map.map_i,self.goal_state_map.map_j) #gives you start and goal point,
		#goal point is acquired from right click
		#little bit hint
		#priority queue, list
